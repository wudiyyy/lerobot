...
#主从Piper下的机器人接口
#区别在于real_M是读取主臂的action数据，real是读取从臂的qpos数据
@RobotConfig.register_subclass("MSpiper")
@dataclass
class MSPiperRobotConfig(RobotConfig):
    inference_time: bool
    #主从臂接口
    MSpiper: dict[str, MotorsBusConfig] = field(
        default_factory=lambda: {
            "main": MSPiperMotorsBusConfig(
                can_name="can_left",
                slaver_motors={
                    "joint_1": [1, "agilex_piper"],
                    "joint_2": [2, "agilex_piper"],
    ...
    cameras: dict[str, CameraConfig] = field(
        default_factory=lambda: {
            ...
            "cam_top": IntelRealSenseCameraConfig(
                serial_number="327122074756",
                # name="Intel RealSense D435I",
                fps=30,
                width=320,
                height=180,
