...
def make_robot_config(robot_type: str, **kwargs) -> RobotConfig:
    ...
    elif robot_type == 'MSpiper':
        return MSPiperRobotConfig(**kwargs)
    else:
...
def make_robot_from_config(config: RobotConfig):
    ...
    elif isinstance(config, MSPiperRobotConfig):
        from lerobot.common.robot_devices.robots.MSpiper import MSPiperRobot

        return MSPiperRobot(config)
    else:
