...
def record(
    ...
    warmup_record(robot, events, enable_teleoperation, cfg.warmup_time_s, cfg.display_cameras, cfg.device, cfg.fps, que, que_observation, policy)

    my_process = Process(target=my_inference, name='inference', args=(policy, cfg.device, cfg.use_amp, que, que_observation))
    my_process.start()
...
if __name__ == "__main__":
    # 强制所有后续的 multiprocessing 实例使用 'spawn'
